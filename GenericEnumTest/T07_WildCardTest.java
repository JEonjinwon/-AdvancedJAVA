...
public class T07_WildCardTest {
	...
	public static void main(String[] args) {
		...
		Course<Student> studentCourse = new Course("직장인 과정", 5);
		studentCourse.add(new Student("학생2"));
		studentCourse.add(new HighStudent("고등학생2"));
		
		Course<HighStudent> highStudentCourse = new Course("직장인 과정", 5);
...
class Course<T>{
	...
	public Course(String name, int capacity) {
		this.name = name;
		//타입 파라미터로 배열을 생성시 오브젝트 배열을 생성후, 타입파라미터 배열로 캐스팅 해야함
